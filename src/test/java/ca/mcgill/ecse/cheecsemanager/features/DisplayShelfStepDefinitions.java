...
public class DisplayShelfStepDefinitions {
  ...
  private static MaturationPeriod parseMaturation(String s) {
    ...
    throw new IllegalArgumentException(
        ...
        + "four possibilities in the MatruationPeriod enum");
  }

  /**
   * This step definition ensures that the shelf from the datatable exists in
   * the system p1.
   *
  ...
  /**
   * This step definition the shelf has the wanted locations given nbrRows and
   * nbrColumns.
   *
   ...
   *
   * @param dataTable The email, password, address, and name of a specified
   ...
   *
   * @param dataTable The date, number of cheese wheels, the months aged of the
   *     cheese wheels, and
  ...
  /**
   * This step definition ensures that each purchase's cheese wheels have been
   * made.
   *
  ...
  /**
   * This step definition ensures that certain ID cheese wheels are located on a
   * chosen shelf based on a given dataTable.
   *
   * @param string The shelf ID
   * @param dataTable The position, in column and row, of a specified cheese ID
   *     on the shelf
   *
   * @author Bassam Baki
   * @author William Zhang
  ...
  public void the_following_cheese_wheel_exists_on_shelf_p1(
      String id, io.cucumber.datatable.DataTable dataTable) {
    List<Map<String, String>> dataAsList = dataTable.asMaps();
  ...
  /**
   * This step definition calls the controller and gets a list of all the
  ...
  /**
   * This step definition verifies that the two shelves created in the Givens
   * are in the system
   *
  ...
  /**
   * This step definition verifies that the shelf details match the expected
   * data table provided.
   *
   * @param dataTable The expected columns: shelf ID, number of columns, number
   *     of rows
   *
   * @author Omar Jaber
   */
  ...
  /**
   * This step definition ensures that the all the positions of each cheese
   * wheel in the shelf is as expected.
   *
  ...
  /**
   * This step definition ensures that the shelf has no cheese wheels assigned
