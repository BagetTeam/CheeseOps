...
public class DisplayCheeseWheelStepDefinitions {
  ...
  public void the_following_order_exists_in_the_system_p10(
    ...
    for (Map<String, String> row : rows) {
      ...
      WholesaleCompany curCompany = WholesaleCompany.hasWithName(companyName)
      ...
      Order newOrder = new Order(
          transactionDate, manager, nrCheeseWheels, maturationPeriod, deliveryDate, curCompany);
    }
  }
    ...
    if (currentPurchase != null) {
      for (int i = 0; i < currentPurchaseCheeseWheelCount; i++) {
        CheeseWheel cheeseWheel =
            new CheeseWheel(currentPurchaseMaturationPeriod, false, currentPurchase, manager);
  ...
  public void the_following_cheese_wheels_shall_be_presented_p10(
    ...
    for (TOCheeseWheel toCheeseWheel : presentedCheeseWheels) {
      ...
      for (var expectedCheeseWheel : expectedCheeseWheels) {
        ...
        assertEquals(
            expectedCheeseWheel.get("isSpoiled"), toCheeseWheel.getIsSpoiled() ? "true" : "false");
        assertEquals(expectedCheeseWheel.get("shelfId"), toCheeseWheel.getShelfID());
        assertEquals(
            expectedCheeseWheel.get("column"), Integer.toString(toCheeseWheel.getColumn()));
        assertEquals(expectedCheeseWheel.get("row"), Integer.toString(toCheeseWheel.getRow()));
        assertEquals(
            expectedCheeseWheel.get("isOrdered"), toCheeseWheel.getIsOrdered() ? "true" : "false");
      }

      assertTrue(foundId,
          "Did not find the TOCheeseWheel object's Id in "
