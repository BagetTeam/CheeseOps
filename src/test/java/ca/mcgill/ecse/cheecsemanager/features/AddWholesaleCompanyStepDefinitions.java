...
public class AddWholesaleCompanyStepDefinitions {
  ...
  public void the_number_of_wholesale_companies_in_the_system_shall_be_p13(Integer numCompanies) {
    ...
    assertEquals(numCompanies.intValue(), actualCount,
        "Expected " + numCompanies + " but got " + actualCount);
  }
  ...
  public void the_wholesale_company_with_address_shall_exist_in_the_system_p13(
      String name, String address) {
    ...
    assertEquals(
        address, company.getAddress(), "The address for company " + name + " does not match.");
  }
  ...
  public void the_following_wholesale_companies_shall_exist_in_the_system_p13(
    ...
    for (var row : rows) {
      ...
      assertEquals(company.getAddress(), expectedAddress,
          "Company with name " + name + " has incorrect address. Expected " + expectedAddress
              + " but got " + company.getAddress() + ".");
    }
  }
