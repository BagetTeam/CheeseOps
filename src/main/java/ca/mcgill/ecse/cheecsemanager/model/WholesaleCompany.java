...
public class WholesaleCompany {
  ...
  public Order addOrder(Date aTransactionDate, CheECSEManager aCheECSEManager, int aNrCheeseWheels,
    ...
    return new Order(
        aTransactionDate, aCheECSEManager, aNrCheeseWheels, aMonthsAged, aDeliveryDate, this);
  }
  ...
  /**
   * private static Map<String, WholesaleCompany> wholesalecompanysByName = new HashMap<String,
   * WholesaleCompany>();
   */
  ...
  public String toString() {
    return super.toString() + "["
        ...
        + ":" + getName() + ","
        + "address"
        + ":" + getAddress() + "]" + System.getProperties().getProperty("line.separator") + "  "
        + "cheECSEManager = "
