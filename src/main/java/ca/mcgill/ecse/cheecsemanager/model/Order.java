...
public class Order extends Transaction {
  ...
  public Order(Date aTransactionDate, CheECSEManager aCheECSEManager, int aNrCheeseWheels,
      MaturationPeriod aMonthsAged, Date aDeliveryDate, WholesaleCompany aCompany) {
  ...
  public String toString() {
    return super.toString() + "["
        + "nrCheeseWheels"
        + ":" + getNrCheeseWheels() + "]" + System.getProperties().getProperty("line.separator")
        + "  "
        + "monthsAged"
        + "="
        ...
        + "deliveryDate"
        + "="
        + (getDeliveryDate() != null ? !getDeliveryDate().equals(this)
                    ? getDeliveryDate().toString().replaceAll("  ", "    ")
                    : "this"
                                     : "null")
        + System.getProperties().getProperty("line.separator") + "  "
        + "company = "
        + (getCompany() != null ? Integer.toHexString(System.identityHashCode(getCompany()))
                                : "null");
  }
}