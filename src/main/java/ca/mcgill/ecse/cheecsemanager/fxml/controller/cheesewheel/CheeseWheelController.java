...
public class CheeseWheelController extends BaseController implements Initializable {
  ...
  public void initialize(URL url, ResourceBundle resourceBundle) {
    super.initializeBreadcrumbNavigation("CheeseWheel");
    parentContainer.addEventHandler(PageSwitchEvent.PAGE_SWITCH, this::changePage);
    parentContainer.fireEvent(new PageSwitchEvent(new NavigationState<>(
        "CheeseWheel", PageType.DISPLAY, "view/page/cheesewheel/CheeseWheelDisplay.fxml")));
  }
