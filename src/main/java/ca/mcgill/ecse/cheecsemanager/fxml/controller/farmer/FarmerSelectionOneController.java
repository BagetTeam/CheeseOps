...
public class FarmerSelectionOneController {
  ...
  @FXML private TableColumn<TOFarmer, String> columnName;
  @FXML private TableColumn<TOFarmer, String> columnEmail;
  @FXML private TableColumn<TOFarmer, String> columnAddress;
  @FXML private TableColumn<TOFarmer, RadioButton> columnSelect;
  ...
  public void setAction(Consumer<String> confirmAction, String selectionKey,
      Function<TOFarmer, Boolean> isSelectable) {
    ...
    if (!FormHelper.isEmpty(selectionKey)) {
      TOFarmer preSelection =
          list.stream().filter(it -> selectionKey.equals(it.getEmail())).findFirst().orElse(null);
