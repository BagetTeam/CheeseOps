...
public class TableColumnFactory {
   ...
   */
  public static <S> TableColumn<S, S> createIdColumn(
      String columnName, Function<S, String> idExtractor, Consumer<S> action) {
   ...
   */
  public static <Type> TableColumn<Type, CheckBox> createCheckboxColumn(
      String title, Function<Type, Boolean> valueExtractor) {
