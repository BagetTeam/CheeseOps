...
public class ShelfDisplayManyController implements Initializable {
  ...
  @FXML private TableView<TOShelf> table;
  ...
  public void populateData() {
    ...
    if (scope.containsKey("maxColumns") && scope.get("maxColumns").getScope().equals("BASIC")) {
      TableColumn<TOShelf, String> columnMaxColumns =
          TableColumnFactory.createTableColumn("maxColumns");
    ...
    if (scope.containsKey("idForLocations")
        && scope.get("idForLocations").getScope().equals("ALL")) {
      TableColumn<TOShelf, Button> columnLocations =
          TableColumnFactory.createTableColumn("idForLocations");
      columnLocations.setCellFactory(
          column -> new ButtonCell<>(this::redirectToShelfLocations, null));
    ...
    columnAction.setCellFactory(
        column -> new ActionButtonCell<>(null, this::showDialogDeleteShelf));
