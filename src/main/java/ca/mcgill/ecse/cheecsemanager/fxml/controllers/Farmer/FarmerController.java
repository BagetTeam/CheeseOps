...
public class FarmerController {
    ...
    public void initialize() {
        showPopupBtn.setOnAction(e -> showViewFarmerPopup());
        deleteBtn.setOnAction(e -> showDeleteFarmerPopup());
    }

    // Add Shelf popup
    private void showViewFarmerPopup() {
        contentPane.setEffect(new BoxBlur(5, 5, 3));
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/ca/mcgill/ecse/cheecsemanager/view/components/Farmer/ViewFarmerPopup.fxml"
            ));
            ...
            ViewFarmerPopup controller = loader.getController();
    ...
    private void showDeleteFarmerPopup() {
        contentPane.setEffect(new BoxBlur(5, 5, 3));
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
