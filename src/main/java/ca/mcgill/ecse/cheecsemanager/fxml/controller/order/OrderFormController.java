...
public class OrderFormController implements Initializable {
  ...
  @FXML private Label labelDeliveryDate;
  @FXML private DatePicker inputFieldDeliveryDate;
  @FXML private Label labelCompany;
  @FXML private Button buttonSelectCompany;
  ...
  public void onSelectCompany(ActionEvent actionEvent) {
    ...
    try {
      FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource(
          PACKAGE_ID + "view/page/wholesalecompany/WholesaleCompanySelectionOne.fxml"));
