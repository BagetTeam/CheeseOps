...
public class WholesaleCompanyController extends BaseController implements Initializable {
  ...
  public void initialize(URL url, ResourceBundle resourceBundle) {
    super.initializeBreadcrumbNavigation("WholesaleCompany");
    parentContainer.addEventHandler(PageSwitchEvent.PAGE_SWITCH, this::changePage);
    parentContainer.fireEvent(new PageSwitchEvent(new NavigationState<>("WholesaleCompany",
        PageType.DISPLAY, "view/page/wholesalecompany/WholesaleCompanyDisplay.fxml")));
  }
