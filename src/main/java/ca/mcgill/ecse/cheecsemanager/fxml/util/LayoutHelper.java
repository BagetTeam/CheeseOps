...
public class LayoutHelper {
  ...
  public static int sortGrid(GridPane gridPane, Map<String, AttributeInfo> scope) {
    ...
    // Adds key as column names and values as Nodes (2 Nodes for each key i.e., label (0) and
    // formfiled (1))
    ...
    List<String> sortedKeys =
        keyToNodes.keySet()
            ...
            .sorted(Comparator.comparingInt(key
                -> scope.getOrDefault(key, new AttributeInfo("NA", Integer.MAX_VALUE)).getOrder()))
            .toList();
