...
public class FacilityManagerDisplayController extends BaseDisplayController implements Initializable {
    ...
    public void onAdd(ActionEvent event) {
		NavigationState state = new NavigationState<>("Add FacilityManager", PageType.ADD, "view/page/facilitymanager/FacilityManagerForm.fxml");
