...
public class TOWholesaleCompany {
  ...
  public Integer[] getNrCheeseWheelsOrdereds() {
    Integer[] newNrCheeseWheelsOrdereds =
        nrCheeseWheelsOrdereds.toArray(new Integer[nrCheeseWheelsOrdereds.size()]);
  ...
  public Integer[] getNrCheeseWheelsMissings() {
    Integer[] newNrCheeseWheelsMissings =
        nrCheeseWheelsMissings.toArray(new Integer[nrCheeseWheelsMissings.size()]);
