...
public class Robot {
    ...
    public Robot(int aDirection, CheeseManager aCheeseManager, ShelfSlot aShelfSlot) {
        ...
        if (aCheeseManager == null || aCheeseManager.getRobot() != null) {
            throw new RuntimeException(
                    "Unable to create Robot due to aCheeseManager. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
        }
        cheeseManager = aCheeseManager;
        if (!setShelfSlot(aShelfSlot)) {
            throw new RuntimeException(
                    "Unable to create Robot due to aShelfSlot. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
        }
    ...
    public String toString() {
        return super.toString() + "[" +
                ...
                "  " + "cheeseManager = "
                + (getCheeseManager() != null ? Integer.toHexString(System.identityHashCode(getCheeseManager()))
                        : "null")
